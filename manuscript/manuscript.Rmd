...
`r round(filter(tidy_foodweb_alphas, type=="Extinction", term=="sc.Diam")$conf.high,2)`]), but was simply a consequence of the (expected) lower survival in the original food web (original $\bar W$=
