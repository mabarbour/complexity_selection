...
```{r Evo dynamics derived from observed phenotypic variance-covariance, include=FALSE}
...
```{r Evo-Sim-Hyp-G, echo=FALSE, fig.cap="Evolutionary simulation of a hypothetical G-matrix"}
...
```{r Compare changes in hypothetical G-matric over time, echo=FALSE}
...
```{r Generate random G matrices and simulate Evo Dynamics, include=FALSE}
...
```{r Plot evo sims of many G-matrices, include=FALSE}
...
```{r Evo-Sim-Many-G, echo=FALSE, fig.cap="Evolutionary simulation of a range of G-matrices"}
# Get legend
...
```{r Rate of phenotypic evolution, include=FALSE}
...
```{r Intuition about evolvability, eval=FALSE}
...
```{r Intuition about matrix multiplication, eval=FALSE}
...
```{r Compare evolvabilities at end of simulation, echo=FALSE}
