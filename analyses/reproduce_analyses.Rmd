...
```{r Figure-Univariate-Landscapes, echo=FALSE, eval=FALSE, include=F}
# Get legend
...
```{r Alt Figure-Univariate-Landscapes, echo=FALSE, eval=FALSE, include=F}
# Get legend
...
```{r Egg-Parasitoid-Selection-linear, echo=F, eval=F, include=F}
