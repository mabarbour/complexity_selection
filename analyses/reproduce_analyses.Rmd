...
We write the model in a way that independently estimates the effect of food-web treatment, each trait, and all two-way and three-way statistical interactions, on larva survival. 

```{r Food-web model, cache=TRUE}
foodweb_model <- glmer(
  gall_survival ~ -1 + Foodweb + #sc.Diam + sc.log.Clutch + sc.sqrt.Pref +
...
biased_foodweb_model <- glmer(gall_survival ~ -1 + Foodweb + Foodweb:sc.Diam + (1|Genotype/Plant_Position/Gall_Number),
...
foodweb_adj_Diam <- as_tibble(boot_foodweb_model$t) %>%
  mutate(`FoodwebComplex:sc.Diam` = `FoodwebComplex:sc.Diam` - fixef(biased_foodweb_model)["FoodwebComplex:sc.Diam"],
         ...
         #`FoodwebComplex:I(sc.Diam^2)` = `FoodwebComplex:I(sc.Diam^2)` - fixef(biased_foodweb_model)["FoodwebComplex:I(sc.Diam^2)"],
         #`FoodwebSimple:I(sc.Diam^2)` = `FoodwebSimple:I(sc.Diam^2)` - fixef(biased_foodweb_model)["FoodwebSimple:I(sc.Diam^2)"],
         #`FoodwebComplex:sc.Diam:sc.log.Clutch` = `FoodwebComplex:sc.Diam:sc.log.Clutch` - fixef(biased_foodweb_model)["FoodwebComplex:sc.Diam:sc.log.Clutch"],
         #`FoodwebSimple:sc.Diam:sc.log.Clutch` = `FoodwebSimple:sc.Diam:sc.log.Clutch` - fixef(biased_foodweb_model)["FoodwebSimple:sc.Diam:sc.log.Clutch"],
         #`FoodwebComplex:sc.Diam:sc.sqrt.Pref` = `FoodwebComplex:sc.Diam:sc.sqrt.Pref` - fixef(biased_foodweb_model)["FoodwebComplex:sc.Diam:sc.sqrt.Pref"],
         #`FoodwebSimple:sc.Diam:sc.sqrt.Pref` = `FoodwebSimple:sc.Diam:sc.sqrt.Pref` - fixef(biased_foodweb_model)["FoodwebSimple:sc.Diam:sc.sqrt.Pref"])
...
foodweb_alphas <- foodweb_adj_Diam %>%
  rename(`FoodwebSimple:(Intercept)`=FoodwebSimple, `FoodwebComplex:(Intercept)`=FoodwebComplex) %>%
...
plot_foodweb_mean_fitness <- tidy_foodweb_alphas %>%
  ...
  ggplot(., aes(x=type)) +
  geom_linerange(aes(ymax=inverse_logit(conf.high), ymin=inverse_logit(conf.low), color=type), position=dodge_width) +
  geom_point(aes(y=inverse_logit(mean), fill=type), position=dodge_width, shape=21, color="black", size=point.size) +
  ...
  scale_y_continuous(name="Larva survival", limits=c(0,1), breaks=c(0,0.2,0.4,0.6,0.8,1)) +
  xlab("Food web") +
...
egglarval_adj_Diam <- as_tibble(boot_egglarval_model$t) %>%
  mutate(`FoodwebComplex:sc.Diam` = `FoodwebComplex:sc.Diam` - fixef(biased_egglarval_model)["FoodwebComplex:sc.Diam"],
         ...
         #`FoodwebComplex:I(sc.Diam^2)` = `FoodwebComplex:I(sc.Diam^2)` - fixef(biased_egglarval_model)["FoodwebComplex:I(sc.Diam^2)"],
         #`FoodwebSimple:I(sc.Diam^2)` = `FoodwebSimple:I(sc.Diam^2)` - fixef(biased_egglarval_model)["FoodwebSimple:I(sc.Diam^2)"],
         #`FoodwebComplex:sc.Diam:sc.log.Clutch` = `FoodwebComplex:sc.Diam:sc.log.Clutch` - fixef(biased_egglarval_model)["FoodwebComplex:sc.Diam:sc.log.Clutch"],
         #`FoodwebSimple:sc.Diam:sc.log.Clutch` = `FoodwebSimple:sc.Diam:sc.log.Clutch` - fixef(biased_egglarval_model)["FoodwebSimple:sc.Diam:sc.log.Clutch"],
         #`FoodwebComplex:sc.Diam:sc.sqrt.Pref` = `FoodwebComplex:sc.Diam:sc.sqrt.Pref` - fixef(biased_egglarval_model)["FoodwebComplex:sc.Diam:sc.sqrt.Pref"],
         #`FoodwebSimple:sc.Diam:sc.sqrt.Pref` = `FoodwebSimple:sc.Diam:sc.sqrt.Pref` - fixef(biased_egglarval_model)["FoodwebSimple:sc.Diam:sc.sqrt.Pref"])
...
# convert "gall_survival" to egg parasitoid survival. Note that both Iteomyia pupa and larva parasitoids result in 0.
...
eggegg_adj_Diam <- as_tibble(boot_eggegg_model$t) %>%
  mutate(`FoodwebComplex:sc.Diam` = `FoodwebComplex:sc.Diam` - fixef(biased_eggegg_model)["FoodwebComplex:sc.Diam"],
         ...
         #`FoodwebComplex:I(sc.Diam^2)` = `FoodwebComplex:I(sc.Diam^2)` - fixef(biased_eggegg_model)["FoodwebComplex:I(sc.Diam^2)"],
         #`FoodwebSimple:I(sc.Diam^2)` = `FoodwebSimple:I(sc.Diam^2)` - fixef(biased_eggegg_model)["FoodwebSimple:I(sc.Diam^2)"],
         #`FoodwebComplex:sc.Diam:sc.log.Clutch` = `FoodwebComplex:sc.Diam:sc.log.Clutch` - fixef(biased_eggegg_model)["FoodwebComplex:sc.Diam:sc.log.Clutch"],
         #`FoodwebSimple:sc.Diam:sc.log.Clutch` = `FoodwebSimple:sc.Diam:sc.log.Clutch` - fixef(biased_eggegg_model)["FoodwebSimple:sc.Diam:sc.log.Clutch"],
         #`FoodwebComplex:sc.Diam:sc.sqrt.Pref` = `FoodwebComplex:sc.Diam:sc.sqrt.Pref` - fixef(biased_eggegg_model)["FoodwebComplex:sc.Diam:sc.sqrt.Pref"],
         #`FoodwebSimple:sc.Diam:sc.sqrt.Pref` = `FoodwebSimple:sc.Diam:sc.sqrt.Pref` - fixef(biased_eggegg_model)["FoodwebSimple:sc.Diam:sc.sqrt.Pref"])
...
```{r simulate bias in chamber diameter}
n <- 10000
diam <- rnorm(n, mean=0, sd=1) # simulate 1,000 chamber diameters from a normal distribution with mean=0 and sd=1
pref <- rnorm(n, mean=0, sd=1)               # simulate 1,000 female preferences from a normal distribution with mean=0 and sd=1
