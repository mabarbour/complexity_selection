...
AF_gradients <- plot_grid(AF_uni_legend, AF_uni_plots, nrow = 2, rel_heights = c(0.2,0.8)) 
AF_gradients
```

```{r Figure-Univariate-Landscapes, echo=FALSE}
# Get legend
...
save_plot(filename = "selection_on_Platygaster.pdf", plot = eggptoid_selection_plot, base_height = 6)
```
