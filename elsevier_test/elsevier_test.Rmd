...
BREAK UP INTO INDIVIDUAL PIECES: E.G. GALL SIZE. THIS SHOULD BE SMALL ENOUGH TO ALLOW CACHING

```{r Get Univariate Fitness Landscapes, echo=FALSE, message=FALSE, warning=FALSE}
## Gall size ----
...
```{r Plot Univariate Landscapes, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Get Multivariate Landscapes, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Plot Multivariate Fitness Landscape, echo=FALSE, message=FALSE, warning=FALSE}
