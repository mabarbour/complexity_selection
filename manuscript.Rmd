...
The indirect effects of selection on genetic constraints is governed by the curvature of the adaptive landscape, which in our study corresponds to:
...
The fact that more traits contributed to the slope of the adaptive landscape (number of traits under directional selection) in the simple food web suggests that the trajectory of evolution is more constrained. For the phenotypic traits we examine, it also implies that there is an optimal combination of phenotypes that maximizes larval survival (i.e. large chamber diameter, small clutch sizes, and avoid conspecifics) in simpler food webs. In contrast, there are no selective constrains on the evolution of clutch size and oviposition preference in the more complex food web. This suggests that there are multiple adaptive peaks, or in this case, a flat adaptive landscape across these phenotypic traits, such that there are no consequences to move across the adaptive landscape in these directions. Interestingly, this also implies that as selective constraints weaken in more complex food webs, then the trajectory of evolution becomes more influenced by genetic constraints, or the population's G-matrix. This is made clear if we inspect the 'Lande equation', $\Delta z = \text{G} \beta$, where G corresponds to the populations additive genetic variance and covariances between traits (G-matrix). As the components of $\beta$ go to zero, then $\Delta z$ is more influenced by the G-matrix. Interestingly, this corresponds to data on trait evolution in complex natural systems. Specifically, @Schluter1996 suggested that evolution often follows 'genetic lines of least resistance'. This data came from data on natural populations of threespine sticklebacks, three species of songbirds, and *Peromyscus* mice. This also implies that simplification of ecological communities may actually reduce the predictability of phenotypic evolution, because knowledge is required of both selective and genetic constraints, rather than potentially just genetic constraints in more complex systems. This insight also helps resolve the balance between neutral and adaptationist views of phenotypic evolution. In fact, the ability for neutral evolutionary theories to give insight to evolution may be due to the net neutral selection pressures in complex natural systems. However, this highlights that we will need further integration of these perspectives in the context of global change and concomittant changes in the selective environment.

Moreover, current theoretical models of evolution in a community context often focus on the evolution of a single trait. Our results highlight though, that in the context of global change, we may begin to experience selection changing to cause change in multiple traits that influence fitness. 
...
In addition, we also found that the indirect effects of selection on genetic constraints were fewer in complex vs. simpler food webs. Key components that contribute to the evolvability of populations are determined by the additive genetic variance in traits as well as patterns of additive genetic covariance (i.e. G-matrix structure). Specifically, weak covariances allow trait evolution to be independent, which gives more autonomy in trait evolutionary responses to changing environments. Similar, decreases in genetic variance contstrain potential for the trait itself to evolve. Together, this suggest the simpler food webs can actually act to decrease the evolutionary potential of populations by indirectly selecting for decrases in genetic variance in multiple traits and favoring trait integration [@Hansen2008]. At present, these indirect effects of selection imposed by the community context are often ignored in theoretical models, often assuming genetic variance is unchanging parameter in models. Our empirical results highlight the need to explore the evolutionary consequences of how not only the direct (current focus), but indirect effects of community context on phenotypic evolution. 
...
Our study gives insight to how local extinctions, and concomitant decreases in food-web complexity, increases evolutionary constraints. This occurs because selection imposed by simpler food webs constrains optimal evolutionary trajectories and the ability for populations to reach those adaptive peaks (e.g. via genetic constraints). This implies has unexplored, but an insidious effect of local extinctions. Not only may it compromise community robustness and resilience to future change, but it may also cause this at the population level. We are in urgent need of future empirical and theoretical work that understands these rippling effects on the robustness of populations and communities to environmental change. 
