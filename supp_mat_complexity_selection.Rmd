...
## Calculate confidence intervals of relative fitness
relative_fitness_intervals <- function(logistic_model, newdata, bootstraps){
  ...
  absolute_fitness#/mean(absolute_fitness) 
  }
...
boot_Beta_control <- bootMer(glmer_control, FUN = Beta_avg_grad, nsim=1000, parallel="multicore", ncpus=32)
...
## Confidence intervals for selection gradients ----
boot_Beta_treatment <- bootMer(glmer_treatment, FUN = Beta_avg_grad, nsim=1000, parallel="multicore", ncpus=32)
