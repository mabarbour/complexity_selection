...
## Control treatment
Wbar_model_control <-  glmer(gall_survival ~ 1 + (1|Genotype/Plant_Position/Gall_Number),
                         family=binomial(link=logit),
                         data = control_df, glmerControl(optimizer="bobyqa"))
Wbar_control <- inverse_logit(fixef(Wbar_model_control))
...
Wbar_model_treatment <-  glmer(gall_survival ~ 1 + (1|Genotype/Plant_Position/Gall_Number),
                         family=binomial(link=logit),
                         data = treatment_df, glmerControl(optimizer="bobyqa"))
Wbar_treatment <- inverse_logit(fixef(Wbar_model_treatment))
